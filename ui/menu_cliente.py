from services.cliente_service import cadastrar_cliente, buscar_cliente_por_nome, buscar_cliente_por_cpf, alterar_cliente
from utils.formatacao import padronizar_nome, somente_numeros
from ui.menu_receita import menu_receita
    ...
    while True:
        ...
        match opcao:
            ...
            case "2":
                ...
                print(f"Nome: {cliente.status}")
                if cliente:
                    menu_receita(cliente.id)
